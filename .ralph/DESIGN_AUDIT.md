...
- [ ] `web/app/views/entities/trades/show.html.erb` L136-145: trade-group inner `<thead>` uses bare `text-xs text-muted-foreground` instead of `bg-muted/40 text-[10px] uppercase tracking-wide text-muted-foreground/90 font-medium`
