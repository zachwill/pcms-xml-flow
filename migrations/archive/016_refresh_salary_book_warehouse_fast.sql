-- 016_refresh_salary_book_warehouse_fast.sql
--
-- Replace refresh function to populate pcms.salary_book_warehouse
-- WITHOUT depending on views.
--
-- This avoids accidental re-inlining of expensive window logic (and keeps the
-- “salary book table” concept independent from any particular view strategy).
