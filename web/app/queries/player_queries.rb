class PlayerQueries
  class << self
    ...
    def fetch_salary_rows(contract_id, version_number)
    ...
    def fetch_protection_rows(contract_id, version_number)
      contract_sql = conn.quote(contract_id)
      version_sql = conn.quote(version_number)
    ...
    def fetch_protection_condition_rows(contract_id, version_number)
      contract_sql = conn.quote(contract_id)
      version_sql = conn.quote(version_number)
    ...
    def fetch_bonus_rows(contract_id, version_number)
      contract_sql = conn.quote(contract_id)
      version_sql = conn.quote(version_number)
    ...
    def fetch_bonus_max_rows(contract_id, version_number)
      contract_sql = conn.quote(contract_id)
      version_sql = conn.quote(version_number)
    ...
    def fetch_payment_schedule_rows(contract_id, version_number)
      contract_sql = conn.quote(contract_id)
      version_sql = conn.quote(version_number)
