-- 030_trade_planner_tpe_output_totals.sql
--
-- Enhance pcms.fn_trade_plan_tpe(...) output to include precomputed totals.
--
-- Rationale:
-- Tooling consumers (UI/exports) should not have to re-sum arrays client-side.
-- We return:
-- - totals for found outgoing/incoming sets
-- - totals absorbed into exceptions
-- - totals remaining for the main-leg trade
-- - per-absorption-leg absorbed_cap_total and absorbed_player_ids
