...
module Tools
  class SalaryBookController < ApplicationController
    ...
    def salary_book_queries
      @salary_book_queries ||= SalaryBookQueries.new(connection: conn)
    end
    ...
    def fetch_team_index_rows(year)
      salary_book_queries.team_index_rows(year)
    end
    ...
    def fetch_tankathon_payload(year)
      salary_book_queries.tankathon_payload(year)
    end
